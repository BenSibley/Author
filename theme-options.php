...
function ct_author_options_content() {
	...
	<div id="author-dashboard-wrap" class="wrap">
		...
		<div class="content content-customization">
			...
			<p><?php _e( 'Click the "Customize" link in your menu, or use the button below to get started customizing Author', 'author' ); ?>
				.</p>
		...
		<div class="content content-support">
			...
			<p><?php _e( "You can find the knowledgebase, changelog, support forum, and more in the Author Support Center", "author" ); ?>
				.</p>
		...
		<div class="content content-premium-upgrade">
			...
			<p><?php _e( 'Download the Author Pro plugin and unlock custom colors, featured videos, background images, and more', 'author' ); ?>
				...</p>
		...
		<div class="content content-resources">
			...
			<p><?php _e( 'Save time and money searching for WordPress products by following our recommendations', 'author' ); ?>
				.</p>
