...
if( $previous_post ) {
	...
	$previous_title = get_the_title( $previous_post ) ? get_the_title( $previous_post ) : __("The Previous Post", 'author');
	// get the post link
...
if( $next_post ) {
	...
	$next_title = get_the_title( $next_post ) ? get_the_title( $next_post ) : __("The Next Post", 'author');
	// get the post link
